...
router.post('/allitemsfromcart',auth(endPoint.create),validation(validators.createOrderWithItemsFromCart),asyncHandler(OrderController.createOrderWithItemsFromCart));
